...
public class ThingySimClient {

	private static final Logger LOG = LoggerFactory.getLogger(ThingySimClient.class);
	...
	private final static String DEFAULT_ENDPOINT = "Thingy:91-Test";
