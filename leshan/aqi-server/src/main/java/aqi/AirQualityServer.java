...
public class AirQualityServer {
	...
	private static final Logger LOG = LoggerFactory.getLogger(AirQualityServer.class);
	...
	public static void createAndStartServer(String webAddress, int webPort, String localAddress, Integer localPort,
		...
		root.setContextPath("/");
		root.setResourceBase(AirQualityServer.class.getClassLoader().getResource("webapp").toExternalForm());
