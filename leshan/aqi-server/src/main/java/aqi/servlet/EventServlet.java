...
import aqi.servlet.json.LwM2mNodeSerializer;
import aqi.servlet.json.RegistrationSerializer;
import aqi.servlet.log.CoapMessage;
import aqi.servlet.log.CoapMessageListener;
import aqi.servlet.log.CoapMessageTracer;
		...
		public void onResponse(Observation observation, Registration registration, ObserveResponse response) {
			...
			if (registration != null) {
				String data = new StringBuilder("{\"ep\":\"").append(registration.getEndpoint())
				                     .append("\",\"res\":\"").append(observation.getPath().toString())
